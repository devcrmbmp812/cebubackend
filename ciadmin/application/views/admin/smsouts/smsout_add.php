    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-body with-border">
                <div class="col-md-6">
                    <h4><i class="fa fa-plus"></i> &nbsp; Add New Sms Out</h4>
                </div>
        ...
        <div class="col-md-12">
            <div class="box border-top-solid">
                ...
                <div class="box-body my-form-body">
                    ...
                    <?php echo form_open(base_url('admin/smsouts/add'), 'class="form-horizontal"');  ?>
                    ...
                    <div class="form-group">
                        <label for="recipient_number" class="col-sm-2 control-label">Recipient Number</label>

                        <div class="col-sm-9">
                            <input type="text" name="recipient_number" class="form-control" id="recipient_number" placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-11">
                            <input type="submit" name="submit" value="Add SMS Out" class="btn btn-info pull-right">
                        </div>
                    </div>
                    <?php echo form_close( ); ?>
                </div>
