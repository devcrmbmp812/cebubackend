            ...
            <div class="box box-body">
                ...
                <div class="col-md-6 text-right">
                    <div class="btn-group margin-bottom-20">
                        <a href="<?= base_url('admin/admins/create_admins_pdf'); ?>" class="btn btn-success">Export as PDF</a>
                        <a href="<?= base_url('admin/admins/export_csv'); ?>" class="btn btn-success">Export as CSV</a>
                    </div>
                </div>
